...
<head>
<meta charset="UTF-8" />
<title>Invoice ${invoiceNum} — FlarePay</title>
<style>
  @page {
    size: A4 landscape;
    margin: 0;
...
<div class="page">
  ...
  <div class="header">
    <div class="brand">
      <img src="${logoUrl}" alt="FlarePay logo" />
      <div class="brand-text">
        <h2>FlarePay</h2>
        <p>Flare Testnet Coston2 · trustless payments</p>
      </div>
    </div>
  ...
  <div class="footer">
    <span>Generated by FlarePay · Flare Testnet Coston2</span>
    ${data.explorerUrl
